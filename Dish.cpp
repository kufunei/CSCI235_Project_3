...
*/
bool Dish::operator == (const Dish& right_hand_side_dish) const
{
    if (name_ == right_hand_side_dish.name_ && cuisine_type_ == right_hand_side_dish.cuisine_type_ && prep_time_ == right_hand_side_dish.prep_time_ && price_ == right_hand_side_dish.price_)
    {
        return true;
    }
    else
